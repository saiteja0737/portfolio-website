...
const projects = [
  ...
  },
  {
    ...
    oneliner: 'Created an LLM-powered pipeline to generate daily AI news insights at zero API cost.',
    tech: ['Python', 'Ollama', 'BeautifulSoup', 'LLMs'],
    github: 'https://github.com/saiteja0737/AI-News-Analyzer',
    problem: 'Generate daily AI news insights without relying on costly APIs.',
    approach: 'Developed an LLM-powered pipeline using local models to scrape, process, and summarize news articles into structured insights.',
    impact: 'Delivered automated daily summaries at zero API cost, improving accessibility to AI trends.',
  },
  {
